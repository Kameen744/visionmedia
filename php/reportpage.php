<?php
	...
	<nav class="nav justify-content-center">
		...
		<a class="nav-link btn btn-danger btn-sm mx-1 py-1 m-1" href="#" id="progsVerify">Verify Log</a>
		<a class="nav-link btn btn-danger btn-sm mx-1 py-1 m-1" href="#" id="oapgetrs">O A P</a>
	</nav>
