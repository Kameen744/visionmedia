...
<form id="RegStaffForm">
	<h4 class="text-center alert alert-danger">Bio Data</h4>	
<div class="row">
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">First & Second Name</i>			
		<input type="text" name="S_Name" class="form-control" placeholder="Full Name" required="" id="ClientNameInput">
	</div>
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Phone Number</i>
		<input type="text" name="S_Number" class="form-control" maxlength="11" placeholder="Phone Number" required="">
	</div>
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">E-mail Address</i>
		<input type="email" name="S_Email" class="form-control" value="<?= $_SESSION['user_email'] ?>" placeholder="E-Mail" required="">
	</div>

	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Date of Birth</i>
		<input type="text" name="S_Dateofbirth" class="form-control" placeholder="20/12/2000" required="">
	</div>
</div>
<div class="row">
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Gender</i>
	...
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Marital Status</i>
	...
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Nationality</i>
		<input type="text" name="S_Natiolity" class="form-control" required="" placeholder="Nationaliy" >
	</div>
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">State of Origin</i>
		<input type="text" name="S_State" class="form-control" required="" placeholder="State of Origin" >
	</div>
</div>
<div class="row">
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Local Government</i>
		<input type="text" name="S_Lga" class="form-control" placeholder="L.G.A" required="">
	</div>
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Contact Address</i>
		<input type="text" name="S_Address" class="form-control" placeholder="Contact Address">
	</div>
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Highers Qualification</i>
		<input type="text" name="S_Qualification" class="form-control" placeholder="Qualification">
	</div>	
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Job Tittle</i>
		<input type="text" name="S_Title" id="S_Title" class="form-control" placeholder="Job Title" required="">
			
	</div>
</div>
<div class="row">
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Grade Level</i>
	...
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Bank</i>
		<input type="text" name="S_Bank" id="S_Bank" class="form-control" placeholder="Bank">
	...
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Account Name</i>
		<input type="text" name="S_AccName" class="form-control" placeholder="Account Name">
	</div>
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Account Number</i>
...
<div class="row">
	...
	<div class="col-md-12">
		<hr>
		<button id="RegisterNewStaff" class="btn btn-danger btn-block">Save & Next</button>
	</div>
</div>
</form>
...
<form style="padding-bottom: 5px; display: none;" id="SchoolsAttendedDates">
	<h2 class="text-center alert alert-danger">Schools Atended with Dates</h2>	
	...
	<div class="row">
		<div class="form-group col-sm-12 col-md-4">
			<label class="text-danger font-weight-bold label">Primary School</label>
			<input name="S_Primary" class="form-control">
		</div>
		<div class="form-group col-sm-12 col-md-4">
			<label class="text-danger font-weight-bold label">Qualification Obtained</label>
			<input name="S_PrimaryQual" class="form-control" placeholder="Primary School Certificate" id="PrmQl">
		</div>
		<div class="form-group col-sm-12 col-md-2">
			<label class="text-danger font-weight-bold label">Start From</label>
			<input type="text" name="S_Prfrom" class="form-control" placeholder="20/12/2000">
		</div>
		<div class="form-group col-sm-12 col-md-2">
			<label class="text-danger font-weight-bold label">Finished</label>
			<input type="text" name="S_Prto" class="form-control" placeholder="20/12/2000">
		</div>
	</div>
	...
	<div class="row">
		<div class="form-group col-sm-12 col-md-4">
			<label class="text-danger font-weight-bold label">Secondary School</label>
		...
		<div class="form-group col-sm-12 col-md-2">
			<label class="text-danger font-weight-bold label">Start From</label>
			<input type="text" name="S_Secfrom" class="form-control" placeholder="20/12/2000">
		</div>
		<div class="form-group col-sm-12 col-md-2">
			<label class="text-danger font-weight-bold label">Finished</label>
			<input type="text" name="S_Secto" class="form-control" placeholder="20/12/2000">
		</div>
	</div>
	...
	<div class="row">
		<div class="form-group col-sm-12 col-md-4">
			<label class="text-danger font-weight-bold label">Tertiary Institution</label>
		...
		<div class="form-group col-sm-12 col-md-2">
			<label class="text-danger font-weight-bold label">Start From</label>
			<input type="text" name="S_Terfrom" class="form-control" placeholder="20/12/2000">
		</div>
		<div class="form-group col-sm-12 col-md-2">
			<label class="text-danger font-weight-bold label">Finished</label>
			<input type="text" name="S_Terto" class="form-control" placeholder="20/12/2000">
		</div>
	</div>
...
<h4 class="text-center alert alert-danger">Special Skills</h4>	
<div style="display: none;" class="sfIDNo">
...
<div class="row">
	...
	<div class="col-md-12"> 
		<hr>
		<h4 class="text-center alert alert-danger">Working Experience</h4>
	</div>
</div>
<div class="row" id="ExperienceContain">
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Job Title</i>			
		<input type="text" name="job_1" class="form-control" placeholder="Job Title">
	</div>
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Company</i>				
		<input type="text" name="jobcom_1" class="form-control" placeholder="Company">
	</div>
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">Start Date</i>				
		<input type="text" name="jobdatefrom_1" class="form-control" placeholder="From">
	</div>
	<div class="col-md-3 col-sm-12 form-group">
		<i class="text-danger font-weight-bold label">End Date. Skip if still working there</i>				
		<input type="text" name="jobdateto_1" class="form-control" placeholder="To">
	</div>
</div>
<div class="row">
	<div class="col-md-12" style="padding-top: 10px;">
	...
	<div class="col-md-12">
		<hr>
		<button id="SkillsExperienceSubmit" class="btn btn-danger btn-block">Save & Next</button>
	</div>
</div>
</form>

	<!-- Next of Kin & Refrees -->
<form style="padding-bottom: 5px; display: none;" id="NexofkinandRefrees">
<h4 class="text-center alert alert-danger">Next of Kin</h4>	
	<!-- Next of Kin  -->
<div style="display: none;" class="sfIDNo">
...
<hr>
<h4 class="text-center alert alert-danger">Referees</h4>
	<!-- Refree 1  -->
<div class="row">
	<div class="form-group col-md-3">
		<label class="text-danger font-weight-bold label">Referee 1</label>
		<input name="S_Refreeone" class="form-control">
	</div>
	<div class="form-group col-md-3">
		<label class="text-danger font-weight-bold label">Title</label>
		<input type="text" name="S_Refonetit" class="form-control" placeholder="">
	</div>
	<div class="form-group col-md-2">
		<label class="text-danger font-weight-bold label">Phone Number</label>
		<input type="text" name="S_Refonenum" class="form-control" placeholder="">
	</div>
	<div class="form-group col-md-4">
		<label class="text-danger font-weight-bold label">Address</label>
...
<div class="row">
	<div class="form-group col-md-3">
		<label class="text-danger font-weight-bold label">Referee 2</label>
...
<div class="row">
	<div class="form-group col-md-3">
		<label class="text-danger font-weight-bold label">Referee 3</label>
