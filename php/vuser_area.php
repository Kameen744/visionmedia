        ...
        <div id="content">
            ...
            <div class="container-fluid px-3" id="RegisterAdvert">
                <div class="row justify-content-center">
                    ...
                    <input type="text" class="form-control bg-light text-danger" id="SearchText" placeholder="Search for..." aria-label="SearchRec" aria-describedby="basic-addon2">
                    <div class="input-group-append">
                        <button class="btn btn-danger" id="SearchRec" type="button">
